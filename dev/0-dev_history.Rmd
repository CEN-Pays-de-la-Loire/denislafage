...
fusen::fill_description(
  ...
  fields = list(
    Title = "denislfage",
    Description = "A package to say Hello to the world",
    `Authors@R` = c(
      person("Denis", "Lafage", email = "d.lafage@cenpaysdelaloire.fr", role = c("aut", "cre"), comment = c(ORCID = "https://orcid.org/0000-0002-6205-611X"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Denis Lafage")
```
...
# Code of Conduct
usethis::use_code_of_conduct("d.lafage@cenpaysdelaloire.fr")
# NEWS
usethis::use_news_md()
```
